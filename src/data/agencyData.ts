...
export const workflowStages: WorkflowStage[] = [
  {
    ...
    deliverables: ['Понятный план будущего сайта', 'Точная фиксированная цена'],
    icon: 'FileText'
  },
  {
    step: 2,
    ...
    deliverables: ['Наглядный дизайн сайта', 'Простой продающий текст'],
    icon: 'Palette'
  },
  {
    step: 3,
    ...
    deliverables: ['Готовый работающий сайт', 'Подключенная оплата и заявки'],
    icon: 'Code2'
  },
  {
    step: 4,
    ...
    deliverables: ['0% риска: оплата только за результат', 'Запуск сайта в интернете'],
    icon: 'CheckCircle2'
  },
  {
    step: 5,
    ...
    deliverables: ['Простая инструкция для вас', 'Постоянная поддержка в чате'],
    icon: 'Rocket'
  }
];
